...
$.getJSON("/articles", function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
            ...
            $("#articles").append("<div class='saved-div'><p>" + data[i].title + "<br>" + data[i].link +
                "</p><a class='delete' data-id='" + data[i]._id + "'>Remove</a><a class='Comment' data-id='" + data[i]._id +
                "'><span ><i ></i></span>Comments</a></div><a href='/readArticle/{{ this._id }}'>Read Article</a>");
